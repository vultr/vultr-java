...
public class ApiClient {
    ...
    private String basePath = "https://api.vultr.com/v2";
    ...
    public ApiClient() {
        ...
        authentications.put("API Key", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.vultr.com/v2
