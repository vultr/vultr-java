...
import org.openapitools.client.model.AttachReservedIpRequest;
import org.openapitools.client.model.ConvertReservedIpRequest;
import org.openapitools.client.model.CreateReservedIpRequest;
import org.openapitools.client.model.GetReservedIp200Response;
import org.openapitools.client.model.ListReservedIps200Response;
import org.openapitools.client.model.PatchReservedIpsReservedIpRequest;
...
public class ReservedIpApi {
    ...
    public okhttp3.Call attachReservedIpCall(String reservedIp, AttachReservedIpRequest attachReservedIpRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/reserved-ips/{reserved-ip}/attach"
            .replace("{" + "reserved-ip" + "}", localVarApiClient.escapeString(reservedIp.toString()));
    ...
    private okhttp3.Call attachReservedIpValidateBeforeCall(String reservedIp, AttachReservedIpRequest attachReservedIpRequest, final ApiCallback _callback) throws ApiException {
        ...
        return attachReservedIpCall(reservedIp, attachReservedIpRequest, _callback);
    ...
    private okhttp3.Call convertReservedIpValidateBeforeCall(ConvertReservedIpRequest convertReservedIpRequest, final ApiCallback _callback) throws ApiException {
        return convertReservedIpCall(convertReservedIpRequest, _callback);
    ...
    private okhttp3.Call createReservedIpValidateBeforeCall(CreateReservedIpRequest createReservedIpRequest, final ApiCallback _callback) throws ApiException {
        return createReservedIpCall(createReservedIpRequest, _callback);
    ...
    private okhttp3.Call deleteReservedIpValidateBeforeCall(String reservedIp, final ApiCallback _callback) throws ApiException {
        ...
        return deleteReservedIpCall(reservedIp, _callback);
    ...
    private okhttp3.Call detachReservedIpValidateBeforeCall(String reservedIp, final ApiCallback _callback) throws ApiException {
        ...
        return detachReservedIpCall(reservedIp, _callback);
    ...
    private okhttp3.Call getReservedIpValidateBeforeCall(String reservedIp, final ApiCallback _callback) throws ApiException {
        ...
        return getReservedIpCall(reservedIp, _callback);
    ...
    private okhttp3.Call listReservedIpsValidateBeforeCall(Integer perPage, String cursor, final ApiCallback _callback) throws ApiException {
        return listReservedIpsCall(perPage, cursor, _callback);
    ...
    /**
     * Build call for patchReservedIpsReservedIp
     * @param reservedIp The [Reserved IP id](#operation/list-reserved-ips). (required)
     * @param patchReservedIpsReservedIpRequest Include a JSON object in the request body with a content type of **application/json**. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call patchReservedIpsReservedIpCall(String reservedIp, PatchReservedIpsReservedIpRequest patchReservedIpsReservedIpRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = patchReservedIpsReservedIpRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchReservedIpsReservedIpValidateBeforeCall(String reservedIp, PatchReservedIpsReservedIpRequest patchReservedIpsReservedIpRequest, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'reservedIp' is set
        if (reservedIp == null) {
            throw new ApiException("Missing the required parameter 'reservedIp' when calling patchReservedIpsReservedIp(Async)");
        }

        return patchReservedIpsReservedIpCall(reservedIp, patchReservedIpsReservedIpRequest, _callback);
     ...
     */
    public GetReservedIp200Response patchReservedIpsReservedIp(String reservedIp, PatchReservedIpsReservedIpRequest patchReservedIpsReservedIpRequest) throws ApiException {
        ApiResponse<GetReservedIp200Response> localVarResp = patchReservedIpsReservedIpWithHttpInfo(reservedIp, patchReservedIpsReservedIpRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetReservedIp200Response> patchReservedIpsReservedIpWithHttpInfo(String reservedIp, PatchReservedIpsReservedIpRequest patchReservedIpsReservedIpRequest) throws ApiException {
        okhttp3.Call localVarCall = patchReservedIpsReservedIpValidateBeforeCall(reservedIp, patchReservedIpsReservedIpRequest, null);
        Type localVarReturnType = new TypeToken<GetReservedIp200Response>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Update Reserved IP (asynchronously)
     * Update information on a Reserved IP.
     * @param reservedIp The [Reserved IP id](#operation/list-reserved-ips). (required)
     * @param patchReservedIpsReservedIpRequest Include a JSON object in the request body with a content type of **application/json**. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call patchReservedIpsReservedIpAsync(String reservedIp, PatchReservedIpsReservedIpRequest patchReservedIpsReservedIpRequest, final ApiCallback<GetReservedIp200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = patchReservedIpsReservedIpValidateBeforeCall(reservedIp, patchReservedIpsReservedIpRequest, _callback);
        Type localVarReturnType = new TypeToken<GetReservedIp200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
