...
public class UsersApi {
     ...
     * @param createUserRequest Include a JSON object in the request body with a content type of **application/json**. (optional)
     ...
     * @param userId The [User id](#operation/list-users). (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call listUsersCall(BigDecimal perPage, String cursor, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listUsersValidateBeforeCall(BigDecimal perPage, String cursor, final ApiCallback _callback) throws ApiException {
        return listUsersCall(perPage, cursor, _callback);
     ...
     */
    public ListUsers200Response listUsers(BigDecimal perPage, String cursor) throws ApiException {
        ApiResponse<ListUsers200Response> localVarResp = listUsersWithHttpInfo(perPage, cursor);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListUsers200Response> listUsersWithHttpInfo(BigDecimal perPage, String cursor) throws ApiException {
        okhttp3.Call localVarCall = listUsersValidateBeforeCall(perPage, cursor, null);
     ...
     */
    public okhttp3.Call listUsersAsync(BigDecimal perPage, String cursor, final ApiCallback<ListUsers200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = listUsersValidateBeforeCall(perPage, cursor, _callback);
        Type localVarReturnType = new TypeToken<ListUsers200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param userId The [User id](#operation/list-users). (required)
     * @param updateUserRequest Include a JSON object in the request body with a content type of **application/json**. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public void updateUser(String userId, UpdateUserRequest updateUserRequest) throws ApiException {
     ...
     */
    public ApiResponse<Void> updateUserWithHttpInfo(String userId, UpdateUserRequest updateUserRequest) throws ApiException {
     ...
     */
    public okhttp3.Call updateUserAsync(String userId, UpdateUserRequest updateUserRequest, final ApiCallback<Void> _callback) throws ApiException {
