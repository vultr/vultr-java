...
import org.openapitools.client.model.CreateLoadBalancer202Response;
import org.openapitools.client.model.CreateLoadBalancerForwardingRulesRequest;
import org.openapitools.client.model.CreateLoadBalancerRequest;
import org.openapitools.client.model.GetLoadBalancerForwardingRule200Response;
import org.openapitools.client.model.ListLoadBalancerForwardingRules200Response;
import org.openapitools.client.model.ListLoadBalancers200Response;
import org.openapitools.client.model.LoadbalancerFirewallRule;
...
public class LoadBalancerApi {
    ...
    public okhttp3.Call createLoadBalancerForwardingRulesCall(String loadBalancerId, CreateLoadBalancerForwardingRulesRequest createLoadBalancerForwardingRulesRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/load-balancers/{load-balancer-id}/forwarding-rules"
            .replace("{" + "load-balancer-id" + "}", localVarApiClient.escapeString(loadBalancerId.toString()));
    ...
    private okhttp3.Call createLoadBalancerForwardingRulesValidateBeforeCall(String loadBalancerId, CreateLoadBalancerForwardingRulesRequest createLoadBalancerForwardingRulesRequest, final ApiCallback _callback) throws ApiException {
        ...
        return createLoadBalancerForwardingRulesCall(loadBalancerId, createLoadBalancerForwardingRulesRequest, _callback);
    ...
    private okhttp3.Call deleteLoadBalancerValidateBeforeCall(String loadBalancerId, final ApiCallback _callback) throws ApiException {
        ...
        return deleteLoadBalancerCall(loadBalancerId, _callback);
    ...
    public okhttp3.Call deleteLoadBalancerForwardingRuleCall(String loadBalancerId, String forwardingRuleId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/load-balancers/{load-balancer-id}/forwarding-rules/{forwarding-rule-id}"
            .replace("{" + "load-balancer-id" + "}", localVarApiClient.escapeString(loadBalancerId.toString()))
            .replace("{" + "forwarding-rule-id" + "}", localVarApiClient.escapeString(forwardingRuleId.toString()));
    ...
    private okhttp3.Call deleteLoadBalancerForwardingRuleValidateBeforeCall(String loadBalancerId, String forwardingRuleId, final ApiCallback _callback) throws ApiException {
        ...
        return deleteLoadBalancerForwardingRuleCall(loadBalancerId, forwardingRuleId, _callback);
    ...
    /**
     * Build call for deleteLoadBalancerSsl
     * @param loadBalancerId The [Load Balancer id](#operation/delete-load-balancer-ssl). (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call deleteLoadBalancerSslCall(String loadBalancerId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/load-balancers/{load-balancer-id}/ssl"
            .replace("{" + "load-balancer-id" + "}", localVarApiClient.escapeString(loadBalancerId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteLoadBalancerSslValidateBeforeCall(String loadBalancerId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'loadBalancerId' is set
        if (loadBalancerId == null) {
            throw new ApiException("Missing the required parameter 'loadBalancerId' when calling deleteLoadBalancerSsl(Async)");
        }

        return deleteLoadBalancerSslCall(loadBalancerId, _callback);
     ...
     */
    public void deleteLoadBalancerSsl(String loadBalancerId) throws ApiException {
     ...
     */
    public ApiResponse<Void> deleteLoadBalancerSslWithHttpInfo(String loadBalancerId) throws ApiException {
        okhttp3.Call localVarCall = deleteLoadBalancerSslValidateBeforeCall(loadBalancerId, null);
        return localVarApiClient.execute(localVarCall);
    }

    /**
     * Delete Load Balancer SSL (asynchronously)
     * Delete a Load Balancer SSL.
     * @param loadBalancerId The [Load Balancer id](#operation/delete-load-balancer-ssl). (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteLoadBalancerSslAsync(String loadBalancerId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteLoadBalancerSslValidateBeforeCall(loadBalancerId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
    ...
    private okhttp3.Call getLoadBalancerValidateBeforeCall(String loadBalancerId, final ApiCallback _callback) throws ApiException {
        ...
        return getLoadBalancerCall(loadBalancerId, _callback);
    ...
    private okhttp3.Call getLoadBalancerForwardingRuleValidateBeforeCall(String loadBalancerId, String forwardingRuleId, final ApiCallback _callback) throws ApiException {
        ...
        return getLoadBalancerForwardingRuleCall(loadBalancerId, forwardingRuleId, _callback);
    ...
    public okhttp3.Call getLoadbalancerFirewallRuleCall(String loadbalancerId, String firewallRuleId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/load-balancers/{loadbalancer-id}/firewall-rules/{firewall-rule-id}"
            .replace("{" + "loadbalancer-id" + "}", localVarApiClient.escapeString(loadbalancerId.toString()))
            .replace("{" + "firewall-rule-id" + "}", localVarApiClient.escapeString(firewallRuleId.toString()));
    ...
    private okhttp3.Call getLoadbalancerFirewallRuleValidateBeforeCall(String loadbalancerId, String firewallRuleId, final ApiCallback _callback) throws ApiException {
        ...
        return getLoadbalancerFirewallRuleCall(loadbalancerId, firewallRuleId, _callback);
    ...
    private okhttp3.Call listLoadBalancerForwardingRulesValidateBeforeCall(String loadBalancerId, Integer perPage, String cursor, final ApiCallback _callback) throws ApiException {
        ...
        return listLoadBalancerForwardingRulesCall(loadBalancerId, perPage, cursor, _callback);
    ...
    private okhttp3.Call listLoadBalancersValidateBeforeCall(Integer perPage, String cursor, final ApiCallback _callback) throws ApiException {
        return listLoadBalancersCall(perPage, cursor, _callback);
    ...
    private okhttp3.Call listLoadbalancerFirewallRulesValidateBeforeCall(String loadbalancerId, String perPage, String cursor, final ApiCallback _callback) throws ApiException {
        ...
        return listLoadbalancerFirewallRulesCall(loadbalancerId, perPage, cursor, _callback);
    ...
    private okhttp3.Call updateLoadBalancerValidateBeforeCall(String loadBalancerId, UpdateLoadBalancerRequest updateLoadBalancerRequest, final ApiCallback _callback) throws ApiException {
        ...
        return updateLoadBalancerCall(loadBalancerId, updateLoadBalancerRequest, _callback);
