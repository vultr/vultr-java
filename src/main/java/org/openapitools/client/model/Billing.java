...
public class Billing {
  ...
  public Billing id(BigDecimal id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, billing.id) &&
        ...
        Objects.equals(this.type, billing.type) &&
        Objects.equals(this.description, billing.description) &&
        Objects.equals(this.amount, billing.amount) &&
        Objects.equals(this.balance, billing.balance);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, date, type, description, amount, balance);
  }
