...
import org.openapitools.client.model.UpdateLoadBalancerRequestHealthCheck;
...
public class UpdateLoadBalancerRequest {
  ...
  private UpdateLoadBalancerRequestHealthCheck healthCheck;
  ...
  public UpdateLoadBalancerRequest ssl(CreateLoadBalancerRequestSsl ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  **/
  ...
  public UpdateLoadBalancerRequest stickySession(CreateLoadBalancerRequestStickySession stickySession) {
  ...
  **/
  ...
  public UpdateLoadBalancerRequest forwardingRules(List<CreateLoadBalancerRequestForwardingRulesInner> forwardingRules) {
    this.forwardingRules = forwardingRules;
    return this;
  }

  public UpdateLoadBalancerRequest addForwardingRulesItem(CreateLoadBalancerRequestForwardingRulesInner forwardingRulesItem) {
  ...
  **/
  ...
  public UpdateLoadBalancerRequest healthCheck(UpdateLoadBalancerRequestHealthCheck healthCheck) {
  ...
  **/
  @javax.annotation.Nullable
  public UpdateLoadBalancerRequestHealthCheck getHealthCheck() {
    return healthCheck;
  }

  public void setHealthCheck(UpdateLoadBalancerRequestHealthCheck healthCheck) {
    this.healthCheck = healthCheck;
  }


  public UpdateLoadBalancerRequest proxyProtocol(Boolean proxyProtocol) {
  ...
  **/
  ...
  public UpdateLoadBalancerRequest sslRedirect(Boolean sslRedirect) {
  ...
  **/
  ...
  public UpdateLoadBalancerRequest http2(Boolean http2) {
    this.http2 = http2;
    return this;
  }
  ...
  **/
  ...
  public UpdateLoadBalancerRequest nodes(Integer nodes) {
    this.nodes = nodes;
    return this;
  }
  ...
  **/
  ...
  public UpdateLoadBalancerRequest balancingAlgorithm(String balancingAlgorithm) {
  ...
  **/
  ...
  public UpdateLoadBalancerRequest instances(List<String> instances) {
    this.instances = instances;
    return this;
  }

  public UpdateLoadBalancerRequest addInstancesItem(String instancesItem) {
  ...
  **/
  ...
  public UpdateLoadBalancerRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  @Deprecated
  public UpdateLoadBalancerRequest privateNetwork(String privateNetwork) {
  ...
  **/
  ...
  public UpdateLoadBalancerRequest vpc(String vpc) {
    this.vpc = vpc;
    return this;
  }
  ...
  **/
  ...
  public UpdateLoadBalancerRequest firewallRules(List<CreateLoadBalancerRequestFirewallRulesInner> firewallRules) {
    this.firewallRules = firewallRules;
    return this;
  }

  public UpdateLoadBalancerRequest addFirewallRulesItem(CreateLoadBalancerRequestFirewallRulesInner firewallRulesItem) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ssl, updateLoadBalancerRequest.ssl) &&
        Objects.equals(this.stickySession, updateLoadBalancerRequest.stickySession) &&
        Objects.equals(this.forwardingRules, updateLoadBalancerRequest.forwardingRules) &&
        Objects.equals(this.healthCheck, updateLoadBalancerRequest.healthCheck) &&
        Objects.equals(this.proxyProtocol, updateLoadBalancerRequest.proxyProtocol) &&
        Objects.equals(this.sslRedirect, updateLoadBalancerRequest.sslRedirect) &&
        Objects.equals(this.http2, updateLoadBalancerRequest.http2) &&
        Objects.equals(this.nodes, updateLoadBalancerRequest.nodes) &&
        Objects.equals(this.balancingAlgorithm, updateLoadBalancerRequest.balancingAlgorithm) &&
        Objects.equals(this.instances, updateLoadBalancerRequest.instances) &&
        Objects.equals(this.label, updateLoadBalancerRequest.label) &&
        Objects.equals(this.privateNetwork, updateLoadBalancerRequest.privateNetwork) &&
        Objects.equals(this.vpc, updateLoadBalancerRequest.vpc) &&
        Objects.equals(this.firewallRules, updateLoadBalancerRequest.firewallRules);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ssl, stickySession, forwardingRules, healthCheck, proxyProtocol, sslRedirect, http2, nodes, balancingAlgorithm, instances, label, privateNetwork, vpc, firewallRules);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("health_check") != null && !jsonObj.get("health_check").isJsonNull()) {
        UpdateLoadBalancerRequestHealthCheck.validateJsonElement(jsonObj.get("health_check"));
      }
