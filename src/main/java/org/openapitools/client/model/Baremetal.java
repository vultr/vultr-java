...
public class Baremetal {
  ...
  **/
  ...
  public Baremetal userScheme(String userScheme) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, baremetal.id) &&
        ...
        Objects.equals(this.userScheme, baremetal.userScheme);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, os, ram, disk, mainIp, cpuCount, region, defaultPassword, dateCreated, status, netmaskV4, gatewayV4, plan, label, tag, osId, appId, imageId, v6Network, v6MainIp, v6NetworkSize, macAddress, tags, userScheme);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to Baremetal
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Baremetal.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Baremetal.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Baremetal` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("main_ip") != null && !jsonObj.get("main_ip").isJsonNull()) && !jsonObj.get("main_ip").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("netmask_v4") != null && !jsonObj.get("netmask_v4").isJsonNull()) && !jsonObj.get("netmask_v4").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("gateway_v4") != null && !jsonObj.get("gateway_v4").isJsonNull()) && !jsonObj.get("gateway_v4").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("v6_network") != null && !jsonObj.get("v6_network").isJsonNull()) && !jsonObj.get("v6_network").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("v6_main_ip") != null && !jsonObj.get("v6_main_ip").isJsonNull()) && !jsonObj.get("v6_main_ip").isJsonPrimitive()) {
