...
public class Clusters {
  ...
  **/
  ...
  public Clusters region(String region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public Clusters hostname(String hostname) {
  ...
  **/
  ...
  public Clusters deploy(String deploy) {
    this.deploy = deploy;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, clusters.id) &&
        Objects.equals(this.region, clusters.region) &&
        Objects.equals(this.hostname, clusters.hostname) &&
        Objects.equals(this.deploy, clusters.deploy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, region, hostname, deploy);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Clusters.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Clusters` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
