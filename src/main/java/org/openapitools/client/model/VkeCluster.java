...
public class VkeCluster {
  ...
  **/
  ...
  public VkeCluster firewallGroupId(String firewallGroupId) {
  ...
  **/
  ...
  public VkeCluster haControlplanes(Boolean haControlplanes) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, vkeCluster.id) &&
        Objects.equals(this.firewallGroupId, vkeCluster.firewallGroupId) &&
        ...
        Objects.equals(this.haControlplanes, vkeCluster.haControlplanes) &&
        Objects.equals(this.nodePools, vkeCluster.nodePools);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, firewallGroupId, label, dateCreated, clusterSubnet, serviceSubnet, ip, endpoint, version, region, status, haControlplanes, nodePools);
  }
  ...
  * @throws IOException if the JSON Element is invalid with respect to VkeCluster
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!VkeCluster.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!VkeCluster.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `VkeCluster` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
