...
import org.openapitools.client.model.CreateLoadBalancerRequestFirewallRulesInner;
import org.openapitools.client.model.CreateLoadBalancerRequestForwardingRulesInner;
import org.openapitools.client.model.CreateLoadBalancerRequestHealthCheck;
import org.openapitools.client.model.CreateLoadBalancerRequestSsl;
import org.openapitools.client.model.CreateLoadBalancerRequestStickySession;
...
public class CreateLoadBalancerRequest {
  ...
  public static final String SERIALIZED_NAME_BALANCING_ALGORITHM = "balancing_algorithm";
  @SerializedName(SERIALIZED_NAME_BALANCING_ALGORITHM)
  private String balancingAlgorithm;

  public static final String SERIALIZED_NAME_SSL_REDIRECT = "ssl_redirect";
  ...
  private CreateLoadBalancerRequestHealthCheck healthCheck;
  ...
  private List<CreateLoadBalancerRequestForwardingRulesInner> forwardingRules;

  public static final String SERIALIZED_NAME_STICKY_SESSION = "sticky_session";
  @SerializedName(SERIALIZED_NAME_STICKY_SESSION)
  private CreateLoadBalancerRequestStickySession stickySession;

  public static final String SERIALIZED_NAME_SSL = "ssl";
  @SerializedName(SERIALIZED_NAME_SSL)
  private CreateLoadBalancerRequestSsl ssl;
  ...
  private List<CreateLoadBalancerRequestFirewallRulesInner> firewallRules;

  public static final String SERIALIZED_NAME_PRIVATE_NETWORK = "private_network";
  @Deprecated
  ...
  public CreateLoadBalancerRequest region(String region) {
    this.region = region;
    return this;
  }
  ...
  **/
  ...
  public CreateLoadBalancerRequest balancingAlgorithm(String balancingAlgorithm) {
  ...
  **/
  ...
  public void setBalancingAlgorithm(String balancingAlgorithm) {
    this.balancingAlgorithm = balancingAlgorithm;
  }


  public CreateLoadBalancerRequest sslRedirect(Boolean sslRedirect) {
  ...
  **/
  ...
  public CreateLoadBalancerRequest http2(Boolean http2) {
    this.http2 = http2;
    return this;
  }
  ...
  **/
  ...
  public CreateLoadBalancerRequest nodes(Integer nodes) {
    this.nodes = nodes;
    return this;
  }
  ...
  **/
  ...
  public CreateLoadBalancerRequest proxyProtocol(Boolean proxyProtocol) {
  ...
  **/
  ...
  public CreateLoadBalancerRequest healthCheck(CreateLoadBalancerRequestHealthCheck healthCheck) {
  ...
  **/
  @javax.annotation.Nullable
  public CreateLoadBalancerRequestHealthCheck getHealthCheck() {
    return healthCheck;
  }

  public void setHealthCheck(CreateLoadBalancerRequestHealthCheck healthCheck) {
    this.healthCheck = healthCheck;
  }


  public CreateLoadBalancerRequest forwardingRules(List<CreateLoadBalancerRequestForwardingRulesInner> forwardingRules) {
    this.forwardingRules = forwardingRules;
    return this;
  }

  public CreateLoadBalancerRequest addForwardingRulesItem(CreateLoadBalancerRequestForwardingRulesInner forwardingRulesItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<CreateLoadBalancerRequestForwardingRulesInner> getForwardingRules() {
    return forwardingRules;
  }

  public void setForwardingRules(List<CreateLoadBalancerRequestForwardingRulesInner> forwardingRules) {
    this.forwardingRules = forwardingRules;
  }


  public CreateLoadBalancerRequest stickySession(CreateLoadBalancerRequestStickySession stickySession) {
  ...
  **/
  @javax.annotation.Nullable
  public CreateLoadBalancerRequestStickySession getStickySession() {
    return stickySession;
  }

  public void setStickySession(CreateLoadBalancerRequestStickySession stickySession) {
    this.stickySession = stickySession;
  }


  public CreateLoadBalancerRequest ssl(CreateLoadBalancerRequestSsl ssl) {
    this.ssl = ssl;
    return this;
  }
  ...
  **/
  @javax.annotation.Nullable
  public CreateLoadBalancerRequestSsl getSsl() {
    return ssl;
  }

  public void setSsl(CreateLoadBalancerRequestSsl ssl) {
    this.ssl = ssl;
  }


  public CreateLoadBalancerRequest label(String label) {
    this.label = label;
    return this;
  }
  ...
  **/
  ...
  public CreateLoadBalancerRequest instances(List<String> instances) {
    this.instances = instances;
    return this;
  }

  public CreateLoadBalancerRequest addInstancesItem(String instancesItem) {
  ...
  **/
  ...
  public CreateLoadBalancerRequest firewallRules(List<CreateLoadBalancerRequestFirewallRulesInner> firewallRules) {
    this.firewallRules = firewallRules;
    return this;
  }

  public CreateLoadBalancerRequest addFirewallRulesItem(CreateLoadBalancerRequestFirewallRulesInner firewallRulesItem) {
  ...
  **/
  @javax.annotation.Nullable
  public List<CreateLoadBalancerRequestFirewallRulesInner> getFirewallRules() {
    return firewallRules;
  }

  public void setFirewallRules(List<CreateLoadBalancerRequestFirewallRulesInner> firewallRules) {
    this.firewallRules = firewallRules;
  }


  @Deprecated
  public CreateLoadBalancerRequest privateNetwork(String privateNetwork) {
  ...
  **/
  ...
  public CreateLoadBalancerRequest vpc(String vpc) {
    this.vpc = vpc;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.region, createLoadBalancerRequest.region) &&
        Objects.equals(this.balancingAlgorithm, createLoadBalancerRequest.balancingAlgorithm) &&
        Objects.equals(this.sslRedirect, createLoadBalancerRequest.sslRedirect) &&
        Objects.equals(this.http2, createLoadBalancerRequest.http2) &&
        Objects.equals(this.nodes, createLoadBalancerRequest.nodes) &&
        Objects.equals(this.proxyProtocol, createLoadBalancerRequest.proxyProtocol) &&
        Objects.equals(this.healthCheck, createLoadBalancerRequest.healthCheck) &&
        Objects.equals(this.forwardingRules, createLoadBalancerRequest.forwardingRules) &&
        Objects.equals(this.stickySession, createLoadBalancerRequest.stickySession) &&
        Objects.equals(this.ssl, createLoadBalancerRequest.ssl) &&
        Objects.equals(this.label, createLoadBalancerRequest.label) &&
        Objects.equals(this.instances, createLoadBalancerRequest.instances) &&
        Objects.equals(this.firewallRules, createLoadBalancerRequest.firewallRules) &&
        Objects.equals(this.privateNetwork, createLoadBalancerRequest.privateNetwork) &&
        Objects.equals(this.vpc, createLoadBalancerRequest.vpc);
  }

  @Override
  public int hashCode() {
    return Objects.hash(region, balancingAlgorithm, sslRedirect, http2, nodes, proxyProtocol, healthCheck, forwardingRules, stickySession, ssl, label, instances, firewallRules, privateNetwork, vpc);
  }
  ...
  public String toString() {
    ...
    sb.append("    balancingAlgorithm: ").append(toIndentedString(balancingAlgorithm)).append("\n");
    ...
    sb.append("    stickySession: ").append(toIndentedString(stickySession)).append("\n");
  ...
  static {
    ...
    openapiFields.add("balancing_algorithm");
    openapiFields.add("ssl_redirect");
    ...
    openapiFields.add("sticky_session");
    openapiFields.add("ssl");
    openapiFields.add("label");
    openapiFields.add("instances");
    openapiFields.add("firewall_rules");
    openapiFields.add("private_network");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("balancing_algorithm") != null && !jsonObj.get("balancing_algorithm").isJsonNull()) && !jsonObj.get("balancing_algorithm").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `balancing_algorithm` to be a primitive type in the JSON string but got `%s`", jsonObj.get("balancing_algorithm").toString()));
      }
      // validate the optional field `health_check`
      if (jsonObj.get("health_check") != null && !jsonObj.get("health_check").isJsonNull()) {
        CreateLoadBalancerRequestHealthCheck.validateJsonElement(jsonObj.get("health_check"));
      }
      if (jsonObj.get("forwarding_rules") != null && !jsonObj.get("forwarding_rules").isJsonNull()) {
        ...
        if (jsonArrayforwardingRules != null) {
          ...
          for (int i = 0; i < jsonArrayforwardingRules.size(); i++) {
            CreateLoadBalancerRequestForwardingRulesInner.validateJsonElement(jsonArrayforwardingRules.get(i));
          };
        }
      }
      // validate the optional field `sticky_session`
      if (jsonObj.get("sticky_session") != null && !jsonObj.get("sticky_session").isJsonNull()) {
        CreateLoadBalancerRequestStickySession.validateJsonElement(jsonObj.get("sticky_session"));
      }
      // validate the optional field `ssl`
      if (jsonObj.get("ssl") != null && !jsonObj.get("ssl").isJsonNull()) {
        CreateLoadBalancerRequestSsl.validateJsonElement(jsonObj.get("ssl"));
      }
      ...
      if (jsonObj.get("firewall_rules") != null && !jsonObj.get("firewall_rules").isJsonNull()) {
        ...
        if (jsonArrayfirewallRules != null) {
          ...
          for (int i = 0; i < jsonArrayfirewallRules.size(); i++) {
            CreateLoadBalancerRequestFirewallRulesInner.validateJsonElement(jsonArrayfirewallRules.get(i));
          };
        }
      }
      if ((jsonObj.get("private_network") != null && !jsonObj.get("private_network").isJsonNull()) && !jsonObj.get("private_network").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `private_network` to be a primitive type in the JSON string but got `%s`", jsonObj.get("private_network").toString()));
      }
