...
public class UpdateLoadBalancerRequestHealthCheck {
  ...
  * @throws IOException if the JSON Element is invalid with respect to UpdateLoadBalancerRequestHealthCheck
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!UpdateLoadBalancerRequestHealthCheck.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!UpdateLoadBalancerRequestHealthCheck.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UpdateLoadBalancerRequestHealthCheck` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
      ...
      if ((jsonObj.get("check_interval") != null && !jsonObj.get("check_interval").isJsonNull()) && !jsonObj.get("check_interval").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("response_timeout") != null && !jsonObj.get("response_timeout").isJsonNull()) && !jsonObj.get("response_timeout").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("unhealthy_threshold") != null && !jsonObj.get("unhealthy_threshold").isJsonNull()) && !jsonObj.get("unhealthy_threshold").isJsonPrimitive()) {
      ...
      if ((jsonObj.get("healthy_threshold") != null && !jsonObj.get("healthy_threshold").isJsonNull()) && !jsonObj.get("healthy_threshold").isJsonPrimitive()) {
