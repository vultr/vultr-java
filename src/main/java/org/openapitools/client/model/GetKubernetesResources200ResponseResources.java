...
import org.openapitools.client.model.GetKubernetesResources200ResponseResourcesBlockStorageInner;
import org.openapitools.client.model.GetKubernetesResources200ResponseResourcesLoadBalancerInner;
...
public class GetKubernetesResources200ResponseResources {
  ...
  private Set<GetKubernetesResources200ResponseResourcesBlockStorageInner> blockStorage;

  public static final String SERIALIZED_NAME_LOAD_BALANCER = "load_balancer";
  @SerializedName(SERIALIZED_NAME_LOAD_BALANCER)
  private Set<GetKubernetesResources200ResponseResourcesLoadBalancerInner> loadBalancer;
  ...
  * @throws IOException if the JSON Element is invalid with respect to GetKubernetesResources200ResponseResources
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetKubernetesResources200ResponseResources.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetKubernetesResources200ResponseResources.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `GetKubernetesResources200ResponseResources` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
        JsonObject jsonObj = jsonElement.getAsJsonObject();
      if (jsonObj.get("block_storage") != null && !jsonObj.get("block_storage").isJsonNull()) {
        ...
        if (jsonArrayblockStorage != null) {
          ...
          for (int i = 0; i < jsonArrayblockStorage.size(); i++) {
            GetKubernetesResources200ResponseResourcesBlockStorageInner.validateJsonElement(jsonArrayblockStorage.get(i));
          };
        }
      }
      if (jsonObj.get("load_balancer") != null && !jsonObj.get("load_balancer").isJsonNull()) {
        ...
        if (jsonArrayloadBalancer != null) {
          ...
          for (int i = 0; i < jsonArrayloadBalancer.size(); i++) {
            GetKubernetesResources200ResponseResourcesLoadBalancerInner.validateJsonElement(jsonArrayloadBalancer.get(i));
          };
        }
      }
  }
