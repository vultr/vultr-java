...
import org.openapitools.client.model.InstanceV6NetworksInner;
...
public class Instance {
  ...
  private List<InstanceV6NetworksInner> v6Networks;
  ...
  **/
  ...
  public Instance userScheme(String userScheme) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, instance.id) &&
        ...
        Objects.equals(this.userScheme, instance.userScheme);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, os, ram, disk, mainIp, vcpuCount, region, defaultPassword, dateCreated, status, powerStatus, serverStatus, allowedBandwidth, netmaskV4, gatewayV4, v6Networks, hostname, label, tag, internalIp, kvm, osId, appId, imageId, firewallGroupId, features, plan, tags, userScheme);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("power_status") != null && !jsonObj.get("power_status").isJsonNull()) && !jsonObj.get("power_status").isJsonPrimitive()) {
      ...
      if (jsonObj.get("v6_networks") != null && !jsonObj.get("v6_networks").isJsonNull()) {
        ...
        if (jsonArrayv6Networks != null) {
          ...
          for (int i = 0; i < jsonArrayv6Networks.size(); i++) {
            InstanceV6NetworksInner.validateJsonElement(jsonArrayv6Networks.get(i));
          };
        }
      }
      ...
      if ((jsonObj.get("kvm") != null && !jsonObj.get("kvm").isJsonNull()) && !jsonObj.get("kvm").isJsonPrimitive()) {
