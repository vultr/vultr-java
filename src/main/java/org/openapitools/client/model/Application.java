...
public class Application {
  ...
  public static final String SERIALIZED_NAME_DEPLOY_NAME = "deploy_name";
  @SerializedName(SERIALIZED_NAME_DEPLOY_NAME)
  ...
  **/
  ...
  public Application shortName(String shortName) {
  ...
  **/
  ...
  public Application deployName(String deployName) {
  ...
  **/
  ...
  public Application vendor(String vendor) {
    this.vendor = vendor;
    return this;
  }
  ...
  **/
  ...
  public Application imageId(String imageId) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, application.id) &&
        ...
        Objects.equals(this.shortName, application.shortName) &&
        Objects.equals(this.deployName, application.deployName) &&
        Objects.equals(this.type, application.type) &&
        Objects.equals(this.vendor, application.vendor) &&
        Objects.equals(this.imageId, application.imageId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, name, shortName, deployName, type, vendor, imageId);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("deploy_name") != null && !jsonObj.get("deploy_name").isJsonNull()) && !jsonObj.get("deploy_name").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `deploy_name` to be a primitive type in the JSON string but got `%s`", jsonObj.get("deploy_name").toString()));
      }
