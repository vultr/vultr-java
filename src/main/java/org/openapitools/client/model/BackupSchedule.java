...
public class BackupSchedule {
  ...
  public static final String SERIALIZED_NAME_NEXT_SCHEDULED_TIME_UTC = "next_scheduled_time_utc";
  @SerializedName(SERIALIZED_NAME_NEXT_SCHEDULED_TIME_UTC)
  private String nextScheduledTimeUtc;
  ...
  **/
  ...
  public BackupSchedule type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public BackupSchedule nextScheduledTimeUtc(String nextScheduledTimeUtc) {
   ...
   * @return nextScheduledTimeUtc
  **/
  @javax.annotation.Nullable
  public String getNextScheduledTimeUtc() {
    return nextScheduledTimeUtc;
  }

  public void setNextScheduledTimeUtc(String nextScheduledTimeUtc) {
    this.nextScheduledTimeUtc = nextScheduledTimeUtc;
  }


  public BackupSchedule hour(Integer hour) {
    this.hour = hour;
    return this;
  }
  ...
  **/
  ...
  public BackupSchedule dow(Integer dow) {
    this.dow = dow;
    return this;
  }
  ...
  **/
  ...
  public BackupSchedule dom(Integer dom) {
    this.dom = dom;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.enabled, backupSchedule.enabled) &&
        Objects.equals(this.type, backupSchedule.type) &&
        Objects.equals(this.nextScheduledTimeUtc, backupSchedule.nextScheduledTimeUtc) &&
        Objects.equals(this.hour, backupSchedule.hour) &&
        Objects.equals(this.dow, backupSchedule.dow) &&
        Objects.equals(this.dom, backupSchedule.dom);
  }

  @Override
  public int hashCode() {
    return Objects.hash(enabled, type, nextScheduledTimeUtc, hour, dow, dom);
  }
  ...
  public String toString() {
    ...
    sb.append("    nextScheduledTimeUtc: ").append(toIndentedString(nextScheduledTimeUtc)).append("\n");
  ...
  static {
    ...
    openapiFields.add("next_scheduled_time_utc");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("next_scheduled_time_utc") != null && !jsonObj.get("next_scheduled_time_utc").isJsonNull()) && !jsonObj.get("next_scheduled_time_utc").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `next_scheduled_time_utc` to be a primitive type in the JSON string but got `%s`", jsonObj.get("next_scheduled_time_utc").toString()));
      }
  }
