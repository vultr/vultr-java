...
public class Snapshot {
  ...
  **/
  ...
  public Snapshot dateCreated(String dateCreated) {
  ...
  **/
  ...
  public Snapshot size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  **/
  ...
  public Snapshot status(String status) {
   ...
   /**
   * The Snapshot status.  * pending * complete * deleted
   * @return status
  **/
  @javax.annotation.Nullable
  ...
  public Snapshot osId(Integer osId) {
    this.osId = osId;
    return this;
  }

   /**
   * The [Operating System id](#operation/list-os) for this Snapshot.
   * @return osId
  **/
  @javax.annotation.Nullable
  ...
  public Snapshot appId(Integer appId) {
    this.appId = appId;
    return this;
  }

   /**
   * The [Application id](#operation/list-applications) for this snapshot.
   * @return appId
  **/
  @javax.annotation.Nullable
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, snapshot.id) &&
        Objects.equals(this.dateCreated, snapshot.dateCreated) &&
        ...
        Objects.equals(this.osId, snapshot.osId) &&
        Objects.equals(this.appId, snapshot.appId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, dateCreated, description, size, status, osId, appId);
  }
